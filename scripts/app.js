...
function submit() {
  ...
  web3.eth.sendTransaction(
    {
      from: address,
      to: "0x9DeEb7E90e54c11362D29B6D700AEa2328BB8BC4", //0x9DeEb7E90e54c11362D29B6D700AEa2328BB8BC4
                ...
                if (!standardtoken.address) {
                  ...
                  if (isMainNetwork) {
                    statusText.innerHTML =
                      '<p align="center">Contract deployment is in progress - please be patient. If nothing happens for a while check if there\'s any errors in the console (hit F12).<br> <strong>Transaction hash: </strong><br> <a href="https://etherscan.io/tx/' +
                    ...
                    statusText.innerHTML =
                      '<p align="center">Contract deployment is in progress - please be patient. If nothing happens for a while check if there\'s any errors in the console (hit F12). <br> <strong>Transaction hash: </strong><br> <a href="https://ropsten.etherscan.io/tx/' +
                      result.transactionHash +
                      '" target="_blank">' +
                      result.transactionHash +
                      "</a></p>";
                    ...
                    statusText.innerHTML =
                      '<p align="center">Contract deployment is in progress - please be patient. If nothing happens for a while check if there\'s any errors in the console (hit F12). <br> <strong> Transaction hash: </strong><br> <a href="https://rinkeby.etherscan.io/tx/' +
                      result.transactionHash +
                      '" target="_blank">' +
                      result.transactionHash +
                      "</a></p>";
                    ...
                    statusText.innerHTML =
                      "Contract deployment is in progress - please be patient. If nothing happens for a while check if there's any errors in the console (hit F12). Transaction hash: " +
                      result.transactionHash;
                } else {
                  console.log(result);
                  if (isMainNetwork) {
                    statusText.innerHTML =
                      'Transaction  mined! Contract address: <a href="https://etherscan.io/token/' +
                    ...
                    statusText.innerHTML =
                      'Transaction  mined! Contract address: <a href="https://ropsten.etherscan.io/token/' +
                      standardtoken.address +
                      '" target="_blank">' +
                      standardtoken.address +
                      "</a>";
                    ...
                    statusText.innerHTML =
                      'Transaction  mined! Contract address: <a href="https://rinkeby.etherscan.io/token/' +
                      standardtoken.address +
                      '" target="_blank">' +
                      standardtoken.address +
                      "</a>";
                    ...
                    statusText.innerHTML =
                      "Contract deployed at address <b>" +
                      standardtoken.address +
                      "</b> - keep a record of this.";
                }
              } else {
                console.error(error);
                assetFormInput.prop("disabled", false);
